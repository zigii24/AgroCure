...
// Ambil data penyakit
$query = "SELECT * FROM penyakit ORDER BY kode";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['tambah'])) {
    ...
    $query = "INSERT INTO penyakit (kode, nama, deskripsi) VALUES ('$kode', '$nama', '$deskripsi')";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit'])) {
    ...
    $query = "UPDATE penyakit SET kode='$kode', nama='$nama', deskripsi='$deskripsi' WHERE id=$id";
    
    if (mysqli_query($conn, $query)) {
        $_SESSION['success'] = 'Penyakit berhasil diupdate!';
        header('Location: penyakit.php');
        exit;
    } else {
        $error = 'Gagal mengupdate penyakit: ' . mysqli_error($conn);
    }
}
...
if (isset($_GET['delete'])) {
    ...
    $query_aturan = "DELETE FROM aturan WHERE id_penyakit=$id";
    mysqli_query($conn, $query_aturan);
    
    // Hapus penanganan terkait
    $query_penanganan = "DELETE FROM penanganan WHERE id_penyakit=$id";
    mysqli_query($conn, $query_penanganan);
    ...
    if (mysqli_query($conn, $query)) {
        ...
        $error = 'Gagal menghapus penyakit: ' . mysqli_error($conn);
    }
}
?>
...
<head>
    ...
    <title>Kelola Penyakit - AGROCURE</title>
...
<body>
    ...
    <section class="main-content">
        ...
        <div class="welcome-section">
            ...
            <p>Manajemen data penyakit padi dalam sistem AGROCURE</p>
        </div>
        ...
        <!-- Form Tambah/Edit Penyakit -->
        <div class="card">
            <h3><i class="fas fa-plus-circle"></i><?php echo isset($_GET['edit']) ? ' Edit Penyakit' : ' Tambah Penyakit Baru'; ?></h3>
            <form method="POST" action="penyakit.php">
                <?php if (isset($_GET['edit'])): 
                    $edit_id = $_GET['edit'];
                    $query_edit = "SELECT * FROM penyakit WHERE id=$edit_id";
                    $result_edit = mysqli_query($conn, $query_edit);
                    $penyakit_edit = mysqli_fetch_assoc($result_edit);
                ?>
                    <input type="hidden" name="id" value="<?php echo $penyakit_edit['id']; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="kode" name="kode" class="form-control" 
                           value="<?php echo isset($penyakit_edit) ? $penyakit_edit['kode'] : ''; ?>" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" class="form-control" 
                           value="<?php echo isset($penyakit_edit) ? $penyakit_edit['nama'] : ''; ?>" 
                ...
                <div class="form-group">
                    ...
                    <textarea id="deskripsi" name="deskripsi" class="form-control" rows="4" 
                              placeholder="Jelaskan deskripsi penyakit..."><?php echo isset($penyakit_edit) ? $penyakit_edit['deskripsi'] : ''; ?></textarea>
                </div>
                
                <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                    <button type="submit" class="btn">
                        <i class="fas fa-save"></i><?php echo isset($_GET['edit']) ? ' Update Penyakit' : ' Tambah Penyakit'; ?>
                    </button>
        ...
        <!-- Daftar Penyakit -->
        <div class="card">
            <h3><i class="fas fa-list"></i> Daftar Penyakit</h3>
            
            <?php if (empty($penyakit_list)): ?>
                <div class="empty-state">
                    <i class="fas fa-inbox"></i>
                    <h3>Belum ada data penyakit</h3>
                    <p>Mulai dengan menambahkan penyakit baru menggunakan form di atas</p>
                </div>
            <?php else: ?>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($penyakit_list as $penyakit): ?>
                                <tr>
                                    <td><strong><?php echo $penyakit['kode']; ?></strong></td>
                                    <td><?php echo $penyakit['nama']; ?></td>
                                    <td><?php echo strlen($penyakit['deskripsi']) > 100 ? substr($penyakit['deskripsi'], 0, 100) . '...' : $penyakit['deskripsi']; ?></td>
                                    <td>
                                        <div style="display: flex; gap: 0.5rem;">
                                            <a href="penyakit.php?edit=<?php echo $penyakit['id']; ?>" class="btn-edit">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="penyakit.php?delete=<?php echo $penyakit['id']; ?>" class="btn-delete" 
                                               onclick="return confirm('Yakin ingin menghapus penyakit <?php echo $penyakit['nama']; ?>?')">
